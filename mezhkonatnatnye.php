...
<div>
    ...
    <section class="models white_before white_big_after">
        <div class="container">
            <div class="row">
    ...
    <section class="models white_before white_big_after" id="doors">
        <div class="container">
            <div class="row">
                <div class="models_slider">
                    <h2 class="title">За 9 лет работы более 3000<br> удачных проектов</h2>
                    <p></p>
                    <div class="js_slider doors_interroom_02">
                        <div class="door" data-toggle="modal" data-target=".modern">
                            <div class="img_wrap">
