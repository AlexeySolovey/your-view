...
<div class="content" style="margin-bottom: 0px;">
    ...
    <section class="delivery">
        ...
        <div class="full_width_item full_width_item_left aos-init" data-aos="fade-up" style="background-image: url('img/city.png')">
            <div class="container">
                <div class="row">

                    <img class="img-responsive visible-xs" alt="" data-pagespeed-url-hash="2937201376" src="img/city02.png">
                    ...
                    <div class="col-sm-6 col-sm-offset-6 full_width_box">
                        ...
                        <div class="price">
                            ...
                            <form action="" class="select_form ng-pristine ng-valid">
                                <div class="jq-selectbox jqselect delivery_price" style="display: inline-block; position: relative; z-index:100">
                                	<select class="delivery_price" style="margin: 0px; padding: 0px; position: absolute; left: 0px; top: 0px; width: 100%; height: 100%; opacity: 0;">
	                                    ...
	                                    <option value="350">ПВХ двери</option>
	                                    <option value="350">Шпонированные двери</option>
	                                    <option value="800">Двери из массива дерева</option>
                                    </select>
                                    ...
                                    <div class="jq-selectbox__dropdown" style="position: absolute; left: 0px; top: 0px; display: none;">
	                                   	<ul style="position: relative; list-style: none; overflow: auto; overflow-x: hidden">
		                                    ...
		                                    <li style="">ПВХ двери</li>
		                                    <li style="">Шпонированные двери</li>
		                                    <li style="">Двери из массива дерева</li>
	                                	</ul>
                            		</div>
                        		</div>
                            </form>
        ...
        <div class="full_width_item full_width_item_right aos-init" data-aos="fade-up" style="background-image: url('img/Kiev.png')">
            <div class="container">
                <div class="row">
                    <img class="img-responsive visible-xs" alt="" data-pagespeed-url-hash="2306095308" src="img/Kiev02.png">
                    ...
                    <div class="col-sm-6 full_width_box">
                        ...
                        <div class="desc">
                            <p>
                                </p><p><span style="font-family: Roboto, sans-serif; font-size: 14px;">Доставка в пригород Киева осуществляется курьерской службой по указанному Вами адресу на условиях предоплаты заказа банковским переводом. Доставку нестандартных дверей просчитывает менеджер. В стоимость доставки по области входит стоимость доставки по городу + 25 грн/км от КП.</span></p>
                            <p></p>
                        </div>
						<button class="button">
                            <span>
        ...
        <div class="delivery_ua aos-init" data-aos="fade-up">
            <div class="container">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="title">
                        ...
                        <div class="desc">
                            <p>
                            	<span style="font-family: Roboto, sans-serif; font-size: 14px;">Доставка осуществляется по всей Украине.&nbsp;</span><br style="box-sizing: border-box; font-family: Roboto, sans-serif; font-size: 14px; outline: none !important;">
								<span style="font-family: Roboto, sans-serif; font-size: 14px;">Стоимость доставки по тарифам курьерской службы.</span>
							</p>
                        </div>

                        <p>
                            <b>
                                Мы можем отправить двери такими службами доставки:                            
                            </b>
                        </p>
                    </div>
                </div>

                <div class="col-sm-12 delivery_list clearfix">
                    <a href="#">
                    	<img alt="" data-pagespeed-url-hash="297279179" src="img/new.png">
                    </a>
                    <a href="#">
                    	<img alt="" data-pagespeed-url-hash="591779100" src="img/eckss.png">
                    </a>
                    <a href="#">
                    	<img alt="" data-pagespeed-url-hash="886279021" src="img/itaym.png">
                    </a>
                    <a href="#">
                    	<img alt="" data-pagespeed-url-hash="1180778942" src="img/delap.png">
                    </a>
                    <a href="#">
                    	<img alt="" data-pagespeed-url-hash="1475278863" src="img/car+.png">
                    </a>
                </div>
            </div>
        </div>
	        ...
	        <div class="container">
	            <div class="row">
	                ...
	                <div class="col-md-8 col-sm-">
	                    <img src="img/door2.png" class="img-responsive" alt="">
	                </div>
	            </div>
	   	</section>
	</div>
