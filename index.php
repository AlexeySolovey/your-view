...
<section class="anons anons_index">
    <div class="container">
        <div class="row">
            <div class="col-sm-12">
                <div class="title" style="line-height: 60px;">
            ...
            <div class="col-sm-12">
                <div class="anons_block">
                    <div class="anons_block_item aos-init" data-aos="fade-up" data-aos-delay="100">
                            <div class="img">
                                <img class="img-responsive" alt="" src="img/sexangle/eco.png" style="max-width: none;">
                            </div>
                            <div class="text">
                                Экологически <br>
                                чистые материалы<br>
                            ...
                            <div class="img">
                                <img class="img-responsive" alt="" src="img/sexangle/point.png" style="max-width: none;">
                            </div>
                            <div class="text">
                            ...
                            <div class="img">
                                <img class="img-responsive" alt="" src="img/sexangle/zoom.png" style="max-width: none;" >
                            </div>
                            <div class="text">
                            ...
                            <div class="img">
                                <img class="img-responsive" alt="" src="img/sexangle/door_wihte.png" style="max-width: none;">
                            </div>
                            <div class="text">
    ...
    <div class="container">
        <div class="col-sm-12">
            <div class="main_title">
                У нас Вы можете заказать все необходимое <br>
                для обустройства своего дома
...
<section class="produced_mk produced_index">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <!-- <div class="main_title">
                    Мы выполняем комплексный ремонт <br>
            ...
            <div class="col-sm-12">
                ...
                <div class="produced_mk_wrapp clearfix">
                    <div class="col-sm-6">
                        <div class="produced_mk_item">
                            <div class="title">
                                Комплексные  интерьерные  решения                                
                            </div>
                            <div class="desc">
                                Предлагаем качественные работы по изготовлению и установке мебельных комплектов в любом интерьерном стиле, комплекс мер по изменению и улучшению состояния помещений. Заказав услуги в компании Ваш Вид, клиент получит выполнение всех услуг в срок. Все работы осуществляются в гармоничном стиле, с соблюдением единой цветовой гаммы.                                
                            </div>
                            <button class="button" data-toggle="modal" data-target=".modal_call" data-title="Консультация" data-subject="Консультация с главного сайта">
                                Консультация
                            </button>
                        </div>
                    </div>
        ...
        <div class="row">
            <div class="col-12">
                <h2 class="main_title">
                    ...
                    поставщиками комплектующих и материалов
                </h2>
            </div>
